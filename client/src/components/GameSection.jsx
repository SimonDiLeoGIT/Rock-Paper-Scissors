    ...
    if (picked > -1) {
      return (
        <section className="grid z-10 absolute w-screen top-1/3 h-1/2 md:top-1/4">
          <section className="grid grid-cols-2 md:h-1/2">
            <article className="md:m-auto md:mr-8">
              <p className="invisible md:visible md:pb-12 font-semibold"> YOU PICKED </p>
              <Choice className={handleClasses(picked, false)} icon={picked === 0 ? paper_icon : (picked === 1 ? scissors_icon : rock_icon)} />
              <p className="md:invisible"> YOU PICKED </p>
            </article>
            <article className="md:m-auto md:ml-8">
              ...
              <div className="bg-radial-gradient-to h-fit w-fit m-auto rounded-full">
                <Choice className={handleClasses(pc, true)} icon={pc === 0 ? paper_icon : (pc === 1 ? scissors_icon : rock_icon)} />
              </div>
      ...
      return (
        <section className="grid grid-cols-2 z-10 absolute w-screen top-1/3 md:gap-16">
          ...
          <Button className="col-span-1 from-paper-from to-paper-to m-auto mr-8" handleChoice={handleChoice} value={0} icon={paper_icon} setPicked={setPicked} />
          <Button className="col-span-1 from-scissors-from to-scissors-to m-auto ml-8" handleChoice={handleChoice} value={1} icon={scissors_icon} setPicked={setPicked} />
