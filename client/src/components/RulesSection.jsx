export const RulesSection = (props) => {
  return (
    <section className={props.handleRules()}>
      <section className="w-screen h-screen grid grid-rows-4 place-content-center md:max-w-lg md:bg-white md:h-4/5 md:rounded-xl md:grid-cols-2 md:px-12">
        ...
        <img className="row-span-2 m-auto md:col-span-2 md:w-96" alt="rules" src={props.rules} />
